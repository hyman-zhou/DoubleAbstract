 ...
 */
public class DeBlockAlgorithmOfCAAM {
...
//        try {
//            FileOutputStream fileOut = new FileOutputStream("e://a_CAAM.txt");
...
//            e.printStackTrace();
//        }
        System.out.printf("Time to deBlock with CAAM: %d ms. %d,%d,%d,%d,%d\n",endTime-startTime,testTimes1000,testTimes3000,testTimes5000,testTimes10000,testTimesBig);
        System.out.println("End of deblock by CAAM!");
        return jsonResult;
    }
    ...
    private void checkSamePart() throws IOException {
        ...
        for(String testFile:fileList){
            try {
                ...
                System.out.printf("CAAM---%s:发现重复数据 %d 个字节\n",testFile,sameBytes);
